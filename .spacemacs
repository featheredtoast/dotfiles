...
This function should only modify configuration layer settings."
  ...
  (setq-default
   ...
   dotspacemacs-additional-packages '(exec-path-from-shell prettier-js direnv atomic-chrome yaml-imenu helm-rg)
